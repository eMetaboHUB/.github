...
- automating the process of deploying software versions and execution environments to centralized repositories such as Docker Hub, NPM, Maven, and others.
...
If you have jobs that share some characteristics, you can define a template that can be used in several jobs via the "extends" command. 
Each template name starts by a dot.
